...
| 5 | Prevenção de erro | 2 | Confirmação no envio e na rejeição em massa. Mas o default é "Week 1" em Agosto, e um URL de tracking é guardado em silêncio |
...
### A4 [P2] O diálogo de criação são dois números, e o default está errado

`app/dashboard/send/page.tsx:280` e 838-868. Dois inputs numéricos, Week e Year. O estado
inicial de `week` é `1`, não a semana ISO corrente, portanto em Agosto de 2026 o botão de
confirmação diz **"Create Week 1"**.
...
Vinte e quatro achados, dos quais quatro são defeitos de dados ou de segurança que já
