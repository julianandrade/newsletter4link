...
export default function GeneratePage() {
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      const data = await res.json();
      setGenerated(data.newsletter);
      setEditedContent({
        opening: data.newsletter.opening,
        closing: data.newsletter.closing,
        sections: data.newsletter.sections,
      });
      setGenerationStage("Complete!");

      // Refresh editions to get updated generatedContent
      fetchEditions();
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        {/* Empty State */}
        {!generated && !isLoading && selectedEditionId && (
          <Card>
