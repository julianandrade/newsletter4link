...
/**
 * TEMPORARY verification harness. Renders the real Feed, Trends, Editions and
 * Search components behind a fetch stub so the shipped markup can be inspected
 * without a Supabase session. Delete this route once the visual pass is done.
 */
