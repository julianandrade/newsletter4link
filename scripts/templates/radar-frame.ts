...
export function createRadarFrameTemplate(branding: Branding): {
  ...
  <td height="3" style="height:3px; background-color:#dfe3e2; line-height:3px; font-size:0;">&nbsp;</td>
        ...
        row("tldr", [rawHtml("tldr-html", "{{tldr}}")], {
          rowClasses: "u_row card radar-optional",
          columnClasses: "u_column tint",
          columnBackground: CARD,
        }),
        row("top-story", [rawHtml("top-story-html", "{{top_story}}")], {
          rowClasses: "u_row card radar-optional",
        ...
        row("trends", [rawHtml("trends-html", "{{trend_radar}}")], {
          rowClasses: "u_row card radar-optional",
          columnClasses: "u_column tint",
          columnBackground: CARD,
        }),
        row("internal", [rawHtml("internal-html", "{{internal}}")], {
          rowClasses: "u_row card radar-optional",
          columnClasses: "u_column",
          columnBackground: CARD,
        }),
...
<tr class="radar-optional"><td>{{tldr}}</td></tr>
<tr class="radar-optional"><td>{{top_story}}</td></tr>
<tr><td>{{sections}}</td></tr>
<tr class="radar-optional"><td>{{trend_radar}}</td></tr>
<tr class="radar-optional"><td>{{internal}}</td></tr>
